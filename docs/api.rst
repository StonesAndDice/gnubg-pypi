...
This section documents the public Python API provided by the **gnubg** package. It includes functions for evaluating positions, loading neural nets, and accessing internal neural net state.
